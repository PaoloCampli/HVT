...
forvalues year = 2011(1)2015 {
	...
	* Merge
	...
	merge 1:1 origin_name destination_name using ///
			"../input/link/dist_cutoff_1955_80.dta", keepusing(origin_name destination_name distance1955 time1955)
	...
	*drop if distance > 80
	...
	merge 1:1 origin_name destination_name using ///
			"../input/link/dist_cutoff_1955_40.dta", keepusing(origin_name destination_name)
	...
	* This collapse only retains current municipalities
	...
	save "../output/times_byorigin`year'.dta", replace
